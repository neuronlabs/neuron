...
// It is composed of multiple packages where the most important are:
// - controller - is the neuron's core, that registers
// 	and stores the models and contains configurations
