...
func (_m *MockRepository) Create(scope *Scope) *unidb.Error {
	ret := _m.Called(scope)

	var r0 *unidb.Error
	if rf, ok := ret.Get(0).(func(*Scope) *unidb.Error); ok {
		r0 = rf(scope)
	} else {
		if ret.Get(0) != nil {
...
func (_m *MockRepository) Delete(scope *Scope) *unidb.Error {
	ret := _m.Called(scope)
...
func (_m *MockRepository) Get(scope *Scope) *unidb.Error {
	ret := _m.Called(scope)
...
func (_m *MockRepository) List(scope *Scope) *unidb.Error {
	ret := _m.Called(scope)
...
func (_m *MockRepository) Patch(scope *Scope) *unidb.Error {
	ret := _m.Called(scope)
