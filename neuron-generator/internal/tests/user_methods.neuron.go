...
func (u *User) SetPrimaryKeyValue(value interface{}) error {
	...
	case float64:
		u.ID = uint64(valueType)
	default:
		return errors.Newf(mapping.ClassInvalidFieldValue, "provided invalid value: '%T' for the primary field for model: 'User'", value)
	}
	return nil
}
...
func (u *User) GetHashableFieldValue(field *mapping.StructField) (interface{}, error) {
	...
	return nil, errors.Newf(mapping.ClassInvalidModelField, "provided invalid field: '%s' for given model: '%s'", field.Name(), u)
}
