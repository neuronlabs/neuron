...
func (u *User) GetHashableFieldValue(field *mapping.StructField) (interface{}, error) {
	...
	return nil, errors.Newf(mapping.ClassInvalidFieldValue, "provided invalid field: '%s' for given model: '%s'", field.Name(), u)
}
...
func (u *User) SetFieldValue(field *mapping.StructField, value interface{}) (err error) {
	...
	default:
		return errors.Newf(mapping.ClassInvalidFieldValue, "provided invalid field: '%s' for the model: 'User'", field.Name())
	}
	return nil
}
