...
// func TestSafeHashMapAdd(t *testing.T) {
// 	set := NewSafeHashMap()
...
// func TestSafeHashMapContains(t *testing.T) {
// 	set := NewSafeHashMap()
...
// func TestSafeHashMapAddMany(t *testing.T) {
// 	input := []interface{}{}
...
// func TestSafeHashMapLength(t *testing.T) {
// 	set := NewSafeHashMap()
...
// func BenchmarkSafeHashMapSmall(b *testing.B) {
// 	set := NewSafeHashMap()
// 	benchmarkSet(smalls, set, b.N)
// }

// func BenchmarkSafeHashMapMedium(b *testing.B) {
// 	set := NewSafeHashMap()
// 	benchmarkSet(mediums, set, b.N)
// }

// func BenchmarkSafeHashMapBig(b *testing.B) {
// 	set := NewSafeHashMap()
// 	benchmarkSet(bigs, set, b.N)
// }
