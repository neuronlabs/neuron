...
import (
	...
	"github.com/kucjac/jsonapi/pkg/gateway/endpoints"
...
var createValidator, patchValidate *validator.Validate

func init() {
	createValidator, patchValidate = validator.New(), validator.New()
}
...
// Handler is a structure that handles
type Handler struct {
	// controller
	...
	// ModelHandlers
	models map[*mapping.ModelStruct]*endpoints.Model
}
