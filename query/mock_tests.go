...
func (f *Factory) New(*config.Service) (service.Service, error) {
...
func (_m *Repository) Begin(ctx context.Context, tx *Transaction) error {
...
func (_m *Repository) Commit(ctx context.Context, tx *Transaction) error {
	ret := _m.Called(ctx, tx)
...
func (_m *Repository) HealthCheck(context.Context) (*service.HealthResponse, error) {
	return &service.HealthResponse{Status: service.StatusPass}, nil
}
...
func (_m *Repository) Rollback(ctx context.Context, tx *Transaction) error {
	ret := _m.Called(ctx, tx)
