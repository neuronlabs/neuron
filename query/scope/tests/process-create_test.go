...
var _ scope.BeforeCreator = &beforeCreateTestModel{}

type afterCreateTestModel struct {
	ID int `neuron:"type=primary"`
}

var _ scope.AfterCreator = &afterCreateTestModel{}

func (c *beforeCreateTestModel) HBeforeCreate(ctx context.Context, s *scope.Scope) error {
...
func (c *afterCreateTestModel) HAfterCreate(ctx context.Context, s *scope.Scope) error {
	v := ctx.Value(testCtxKey)
	if v == nil {
