...
func (b *JSONAPI) BuildScopeSingle(
	ctx context.Context,
	model interface{},
	query *url.URL,
	id interface{},
...
func (b *JSONAPI) BuildScopeRelated(
	ctx context.Context,
	model interface{},
	query *url.URL,
	flgs ...*flags.Container,
...
func (b *JSONAPI) BuildScopeRelationship(
	ctx context.Context,
	model interface{},
	query *url.URL,
	flgs ...*flags.Container,
...
func (b *JSONAPI) buildQueryParametersSingle(
...
func (b *JSONAPI) setIncludedLangaugeFilters(
	s *scope.Scope,
	languages string,
...
func (b *JSONAPI) modelStruct(model interface{}) (mStruct *models.ModelStruct, err error) {
