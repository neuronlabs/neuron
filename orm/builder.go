...
type Builder interface {
	...
	Update() (int64, error)
	// UpdateAll updates all models in the repository with the selected fields. If the fieldset is not provided the
	// input model would be scanned for all non zero fields and use them in the update process. An input model's primary
	// key must be non zero.
	UpdateAll() (int64, error)
	...
	// Delete deletes models matching given query. If the model has DeletedAt timestamp field it would do the
	// soft delete - update all models matching given query and set their deleted_at field with current timestamp.
	Delete() (int64, error)
	// DeleteAll models matching for given query collection. If the model has DeletedAt timestamp field it would do the
	// soft delete - update all models and set their deleted_at field with current timestamp.
	...
	OrderBy(fields ...*query.SortField) Builder
	...
	Filter(filter *query.FilterField) Builder
	...
	// RemoveRelations clears all 'relationField' relations for given input models.
	// The relation's foreign key must be allowed to set to null.
...
func (b *dbQuery) Insert() error {
	...
	b.setEmptyContext()
	return Insert(b.ctx, b.db, b.scope)
}
...
func (b *dbQuery) Update() (int64, error) {
	...
	b.setEmptyContext()
	return Update(b.ctx, b.db, b.scope)
}

// UpdateAll updates all models for given query.
func (b *dbQuery) UpdateAll() (int64, error) {
	if b.err != nil {
		return 0, b.err
	}
	b.setEmptyContext()
	return UpdateAll(b.ctx, b.db, b.scope)
}
...
func (b *dbQuery) Find() ([]mapping.Model, error) {
	...
	b.setEmptyContext()
	return Find(b.ctx, b.db, b.scope)
}
...
// Delete the models provided in the query's scope.
func (b *dbQuery) Delete() (int64, error) {
	if b.err != nil {
		return 0, b.err
	}
	b.setEmptyContext()
	return Delete(b.ctx, b.db, b.scope)
}

// DeleteAll deletes all the models in the collection.
func (b *dbQuery) DeleteAll() (int64, error) {
	if b.err != nil {
		return 0, b.err
	}
	b.setEmptyContext()
	return DeleteAll(b.ctx, b.db, b.scope)
}
...
func (b *dbQuery) Filter(filter *query.FilterField) Builder {
	if b.err != nil {
		return b
	}
...
func (b *dbQuery) Where(filter string, values ...interface{}) Builder {
	if b.err != nil {
		return b
	}
...
func (b *dbQuery) OrderBy(fields ...*query.SortField) Builder {
	if b.err != nil {
		return b
	}
...
func (b *dbQuery) AddRelations(relationField *mapping.StructField, relations ...mapping.Model) error {
	...
	b.setEmptyContext()
	return AddRelations(b.ctx, b.db, b.scope, relationField, relations...)
}
...
func (b *dbQuery) SetRelations(relationField *mapping.StructField, relations ...mapping.Model) error {
	...
	b.setEmptyContext()
	return SetRelations(b.ctx, b.db, b.scope, relationField, relations...)
}
...
func (b *dbQuery) RemoveRelations(relationField *mapping.StructField) (int64, error) {
	...
	b.setEmptyContext()
	return RemoveRelations(b.ctx, b.db, b.scope, relationField)
}
